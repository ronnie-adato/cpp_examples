...
static IntMatrix random_binary_matrix(std::size_t rows, std::size_t cols, double one_probability, std::mt19937& rng)
{
...
TEST(LargestSquare, AllOnesRectangular)
{
    ...
    LOG(INFO) << "Testing AllOnesRectangular with matrix size: " << matrix.size() << "x"
